  ...
  <div class="px-4 sm:px-16 py-8 bg-gradient-to-br from-purple-50 via-pink-50 to-white min-h-screen">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-2xl mb-8 overflow-hidden border border-purple-100">
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 sm:px-12 py-8">
            ...
            <div class="p-6">
              <div class="space-y-4">
                <div class="text-center">
                  <p class="text-sm text-gray-600 mb-2 font-semibold">Order Status</p>
                  <span 
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-4 text-center border-2 border-purple-100 shadow-md">
                  <p class="text-sm text-gray-600 mb-1 font-semibold">Order Date</p>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="bg-white rounded-2xl shadow-lg overflow-hidden border-2 border-purple-100">
            ...
            <div class="p-6 space-y-4">
              <div class="flex items-start gap-4 bg-gradient-to-r from-purple-50/50 to-pink-50/50 p-5 rounded-xl border-2 border-purple-100 shadow-sm">
                ...
                <div class="flex-1">
                  <p class="text-sm text-gray-600 font-bold mb-1">Shipping Address</p>
                  <p class="text-gray-800 font-medium text-base">{{ order.shippingAddress }}</p>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4 bg-gradient-to-r from-purple-50/50 to-pink-50/50 p-5 rounded-xl border-2 border-purple-100 shadow-sm">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-800 font-medium text-base">{{ order.orderNote }}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl shadow-2xl overflow-hidden border-2 border-purple-400">
          <div class="p-8">
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div class="bg-white/20 backdrop-blur-sm rounded-full p-5 shadow-xl">
